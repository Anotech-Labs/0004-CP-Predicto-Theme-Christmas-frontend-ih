...
const images = [
  {
    ...
    >
      <path
        ...
        fill="#fed358" // Use "#fed358" if you want it to adapt to surrounding text color
      />
      <path
        ...
        fill="#fed358" // Use "#fed358" here too if dynamic color is preferred
      />
    </svg>),
    caption: "Settings"
  },
          ...
          <Box flexGrow={1}>
            ...
            >
              ...
              >
                ...
                <Typography
                  variant="body1"
                  sx={{ marginLeft: "8px", color: "#FED358" }}
                >
                  Log out
                </Typography>
              </Grid>
