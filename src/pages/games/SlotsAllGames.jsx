...
const GameIcons = {
    JILI: (color) => (
        <svg
                ...
                width="45"
                // height="20"
                fill={color === "#232626" ? "#232626" : "#b79c8b"}
            >
                <symbol
                    id="icon-JILI"
                    viewBox="4 12 90 25"
                ...
                <use href="#icon-JILI" fill={color === "#232626" ? "#232626" : "#b79c8b"} />
            </svg>
    ),
    PG: (color) => (
       <svg
            ...
            >
                ...
                <use href="#icon-PG" fill={color === "#232626" ? "#232626" : "#b79c8b"} />
            </svg>
    ),
    CQ9: (color) => (
        <svg
    ...
    EVO: (color) => (
       <svg
            ...
            >
                ...
                {/* Reference the symbol here */}
                <use href="#icon-EVO_Electronic" fill={color === "#232626" ? "#232626" : "#b79c8b"} />
            </svg>
    ),
}
            ...
            >
                <Box sx={{ display: "inline-flex", padding: "0 13px" }}>
                    {Object.keys(GAME_DATA).map((gameKey) => {
                        const color = activeGame === gameKey ? "#232626" : "#b79c8b"
